...
import (
	...
	"github.com/kcp-dev/code-generator/v3/cmd/cluster-client-gen/generators/fake"
...
func GetTargets(context *generator.Context, args *args.Args) []generator.Target {
	...
	for gv, inputDir := range args.GroupVersionPackages() {
		...
		if override := gengo.ExtractCommentTags("+", p.Comments)["groupGoName"]; override != nil { //nolint:staticcheck
